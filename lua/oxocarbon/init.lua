...
vim.api.nvim_set_hl(0, "@string.special", {fg = oxocarbon.base08, bg = oxocarbon.none})
...
vim.api.nvim_set_hl(0, "CmpItemAbbrMatchFuzzy", {fg = oxocarbon.base04, bg = oxocarbon.none, bold = true})
vim.api.nvim_set_hl(0, "BlinkCmpLabel", {fg = oxocarbon.base04, bg = oxocarbon.none, italic = true})
