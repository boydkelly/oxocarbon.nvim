...
<<<<<<< HEAD
vim.api.nvim_set_hl(0, "DiagnosticWarn", {fg = oxocarbon.base12, bg = oxocarbon.base03})
...
vim.api.nvim_set_hl(0, "DiagnosticUnderlineWarn", {fg = oxocarbon.base12, bg = oxocarbon.base03, undercurl = true})
=======
...
<<<<<<< HEAD
vim.api.nvim_set_hl(0, "WarningMsg", {fg = oxocarbon.base12, bg = oxocarbon.base03})
=======
...
vim.api.nvim_set_hl(0, "StatusLineDiagnosticWarn", {fg = oxocarbon.base12, bg = oxocarbon.base03, bold = true})
