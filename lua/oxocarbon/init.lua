...
vim.api.nvim_set_hl(0, "LedgerNumber", {fg = oxocarbon.base09, bg = oxocarbon.none})
...
vim.api.nvim_set_hl(0, "LedgerTransactionDate", {fg = oxocarbon.base14, bg = oxocarbon.none})
