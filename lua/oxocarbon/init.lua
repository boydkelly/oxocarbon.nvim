...
vim.api.nvim_set_hl(0, "FzfLuaHeaderText", {fg = oxocarbon.none, bg = oxocarbon.blend})
vim.api.nvim_set_hl(0, "FzfLuaBufFlagCur", {fg = oxocarbon.none, bg = oxocarbon.blend})
vim.api.nvim_set_hl(0, "FzfLuaTabTitle", {fg = oxocarbon.none, bg = oxocarbon.blend})
...
vim.api.nvim_set_hl(0, "FzfLuaFzfSeparator", {link = "WinSeparator"})
