...
vim.api.nvim_set_hl(0, "Added", {fg = oxocarbon.base07, bg = oxocarbon.none})
vim.api.nvim_set_hl(0, "Changed", {fg = oxocarbon.base09, bg = oxocarbon.none})
vim.api.nvim_set_hl(0, "Removed", {fg = oxocarbon.base10, bg = oxocarbon.none})
...
vim.api.nvim_set_hl(0, "DiffRemove", {link = "Removed"})
