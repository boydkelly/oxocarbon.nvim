...
vim.api.nvim_set_hl(0, "FzfLuaDirPart", {fg = oxocarbon.base05})
vim.api.nvim_set_hl(0, "FzfLuaFilePart", {link = "FzfLuaFzfNormal"})
vim.api.nvim_set_hl(0, "FzfLuaFzfCursorLine", {link = "Visual"})
vim.api.nvim_set_hl(0, "FzfLuaFzfNormal", {fg = oxocarbon.base04})
vim.api.nvim_set_hl(0, "FzfLuaFzfPointer", {fg = oxocarbon.base10})
...
vim.api.nvim_set_hl(0, "FzfLuaNormal", {fg = oxocarbon.base04, bg = oxocarbon.blend})
