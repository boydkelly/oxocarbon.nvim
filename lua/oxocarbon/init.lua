...
vim.api.nvim_set_hl(0, "@field.yaml", {fg = oxocarbon.base09, bg = oxocarbon.none})
vim.api.nvim_set_hl(0, "@string.yaml", {fg = oxocarbon.base15, bg = oxocarbon.none})
vim.api.nvim_set_hl(0, "@punctuation.delimiter.yaml", {fg = oxocarbon.base12, bg = oxocarbon.none})
