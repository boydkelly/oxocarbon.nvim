...
vim.api.nvim_set_hl(0, "NotifyERRORBorder", {fg = oxocarbon.base10, bg = oxocarbon.none})
...
vim.api.nvim_set_hl(0, "NotifyERRORIcon", {fg = oxocarbon.base10, bg = oxocarbon.none})
...
vim.api.nvim_set_hl(0, "NotifyERRORTitle", {fg = oxocarbon.base10, bg = oxocarbon.none})
