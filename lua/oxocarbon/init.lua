...
vim.api.nvim_set_hl(0, "TSBoolean", {fg = _3_, bg = oxocarbon.base00})
local function _4_()
  return FFAB91
end
vim.api.nvim_set_hl(0, "TSCharacter", {fg = _4_, bg = oxocarbon.base00})
...
vim.api.nvim_set_hl(0, "TSNumber", {fg = _5_, bg = oxocarbon.base00})
...
vim.api.nvim_set_hl(0, "TSStringEscape", {fg = disabled, bg = oxocarbon.base00})
...
vim.api.nvim_set_hl(0, "TSText", {fg = text, bg = oxocarbon.base00})
...
vim.api.nvim_set_hl(0, "TSURI", {fg = link, bg = oxocarbon.base00})
