...
vim.api.nvim_set_hl(0, "FzfLuaBackdrop", {fg = oxocarbon.none, bg = oxocarbon.blend})
vim.api.nvim_set_hl(0, "FzfLuaPreviewTitle", {fg = oxocarbon.base02, bg = oxocarbon.base12})
vim.api.nvim_set_hl(0, "FzfLuaTitle", {fg = oxocarbon.base02, bg = oxocarbon.base11})
vim.api.nvim_set_hl(0, "FzfLuaLivePrompt", {fg = oxocarbon.base02, bg = oxocarbon.base12})
vim.api.nvim_set_hl(0, "FzfLuaHeaderText", {fg = oxocarbon.base02, bg = oxocarbon.base11})
vim.api.nvim_set_hl(0, "FzfLuaBorder", {fg = oxocarbon.blend, bg = oxocarbon.blend})
vim.api.nvim_set_hl(0, "FzfLuaDirPart", {link = "FzfLuaNormal"})
vim.api.nvim_set_hl(0, "FzfLuaFzfPointer", {link = "FzfLuaNormal"})
vim.api.nvim_set_hl(0, "FzfLuaFzfInfo", {link = "FzfLuaNormal"})
vim.api.nvim_set_hl(0, "FzfLuaCursor", {link = "FzfLuaNormal"})
vim.api.nvim_set_hl(0, "FzfLuaDirPart", {link = "FzfLuaNormal"})
vim.api.nvim_set_hl(0, "FzfLuaFilePart", {link = "FzfLuaNormal"})
vim.api.nvim_set_hl(0, "FzfLuaFzfCursorLine", {link = "FzfLuaNormal"})
vim.api.nvim_set_hl(0, "FzfLuaFzfPointer", {link = "FzfLuaNormal"})
vim.api.nvim_set_hl(0, "FzfLuaFzfMarker", {link = "FzfLuaNormal"})
vim.api.nvim_set_hl(0, "FzfLuaFzfSpinner", {link = "FzfLuaNormal"})
vim.api.nvim_set_hl(0, "FzfLuaFzfInfo", {link = "FzfLuaNormal"})
vim.api.nvim_set_hl(0, "FzfLuaFzfSeparator", {link = "FzfLuaNormal"})
vim.api.nvim_set_hl(0, "FzfLuaHeaderBind", {link = "FzfLuaNormal"})
vim.api.nvim_set_hl(0, "FzfLuaPath", {link = "FzfLuaNormal"})
vim.api.nvim_set_hl(0, "FzfLuaPathColNr", {link = "FzfLuaNormal"})
vim.api.nvim_set_hl(0, "FzfLuaBufName", {link = "FzfLuaNormal"})
vim.api.nvim_set_hl(0, "FzfLuaBufNr", {link = "FzfLuaNormal"})
vim.api.nvim_set_hl(0, "FzfLuaHeaderBind", {link = "FzfLuaNormal"})
vim.api.nvim_set_hl(0, "FzfLuaHeaderText", {link = "FzfLuaNormal"})
vim.api.nvim_set_hl(0, "FzfLuaPathColNr", {link = "FzfLuaNormal"})
vim.api.nvim_set_hl(0, "FzfLuaPathLineNr", {link = "FzfLuaNormal"})
vim.api.nvim_set_hl(0, "FzfLuaBufNr", {link = "FzfLuaNormal"})
vim.api.nvim_set_hl(0, "FzfLuaBufFlagCur", {link = "FzfLuaNormal"})
vim.api.nvim_set_hl(0, "FzfLuaBufFlagAlt", {link = "FzfLuaNormal"})
vim.api.nvim_set_hl(0, "FzfLuaTabTitle", {link = "FzfLuaNormal"})
vim.api.nvim_set_hl(0, "FzfLuaTabMarker", {link = "FzfLuaNormal"})
vim.api.nvim_set_hl(0, "FzfLuaLivePrompt", {link = "FzfLuaNormal"})
vim.api.nvim_set_hl(0, "FzfLuaLiveSym", {link = "FzfLuaNormal"})
