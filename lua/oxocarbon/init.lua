...
vim.api.nvim_set_hl(0, "GitSignsAdd", {fg = oxocarbon.base7, bg = oxocarbon.base00})
vim.api.nvim_set_hl(0, "GitSignsChange", {fg = oxocarbon.base9, bg = oxocarbon.base00})
vim.api.nvim_set_hl(0, "GitSignsDelete", {fg = oxocarbon.base10, bg = oxocarbon.base00})
...
vim.api.nvim_set_hl(0, "CurSearch", {fg = oxocarbon.base01, bg = oxocarbon.base11})
...
vim.api.nvim_set_hl(0, "WinSeparator", {fg = oxocarbon.base03, bg = oxocarbon.base00})
...
vim.api.nvim_set_hl(0, "@comment", {link = "Comment"})
vim.api.nvim_set_hl(0, "@error", {fg = oxocarbon.base10, bg = oxocarbon.none})
...
vim.api.nvim_set_hl(0, "@string.special", {fg = oxocarbon.base13, bg = oxocarbon.none})
...
vim.api.nvim_set_hl(0, "@field", {fg = oxocarbon.base15, bg = oxocarbon.none})
...
vim.api.nvim_set_hl(0, "@text.literal", {fg = oxocarbon.base14, bg = oxocarbon.none})
...
vim.api.nvim_set_hl(0, "NvimInternalError", {fg = oxocarbon.base10, bg = oxocarbon.none})
...
vim.api.nvim_set_hl(0, "NormalNC", {fg = oxocarbon.base05, bg = oxocarbon.base01})
...
vim.api.nvim_set_hl(0, "StatusLineDiagnosticWarn", {fg = oxocarbon.base14, bg = oxocarbon.none, bold = true})
...
vim.api.nvim_set_hl(0, "csvCol0", {fg = "#878d96", bg = "NONE"})
vim.api.nvim_set_hl(0, "csvCol1", {fg = "#a8a8a8", bg = "NONE"})
vim.api.nvim_set_hl(0, "csvCol2", {fg = "#8d8d8d", bg = "NONE"})
vim.api.nvim_set_hl(0, "csvCol3", {fg = "#a2a9b0", bg = "NONE"})
vim.api.nvim_set_hl(0, "csvCol4", {fg = "#8f8b8b", bg = "NONE"})
vim.api.nvim_set_hl(0, "csvCol5", {fg = "#ada8a8", bg = "NONE"})
vim.api.nvim_set_hl(0, "csvCol6", {fg = "#878d96", bg = "NONE"})
vim.api.nvim_set_hl(0, "csvCol7", {fg = "#a8a8a8", bg = "NONE"})
vim.api.nvim_set_hl(0, "csvCol8", {fg = "#8d8d8d", bg = "NONE"})
vim.api.nvim_set_hl(0, "RainbowDelimitersRed", {link = "csvCol0"})
vim.api.nvim_set_hl(0, "RainbowDelimitersYellow", {link = "csvCol1"})
vim.api.nvim_set_hl(0, "RainbowDelimitersBlue", {link = "csvCol2"})
vim.api.nvim_set_hl(0, "RainbowDelimitersOrange", {link = "csvCol3"})
vim.api.nvim_set_hl(0, "RainbowDelimitersGreen", {link = "csvCol4"})
vim.api.nvim_set_hl(0, "RainbowDelimitersViolet", {link = "csvCol5"})
vim.api.nvim_set_hl(0, "RainbowDelimitersCyan", {link = "csvCol6"})
vim.api.nvim_set_hl(0, "@OrgTSHeadlinelevel1", {link = "markdownH1"})
vim.api.nvim_set_hl(0, "@OrgTSHeadlinelevel2", {link = "markdownH1"})
vim.api.nvim_set_hl(0, "@OrgTSHeadlinelevel3", {link = "markdownH1"})
vim.api.nvim_set_hl(0, "@OrgTSHeadlinelevel4", {link = "markdownH1"})
vim.api.nvim_set_hl(0, "@OrgTSHeadlinelevel5", {link = "markdownH1"})
vim.api.nvim_set_hl(0, "@OrgTSHeadlinelevel6", {link = "markdownH1"})
vim.api.nvim_set_hl(0, "OrgTODO", {link = "@string"})
vim.api.nvim_set_hl(0, "OrgDONE", {link = "@namespace"})
...
vim.api.nvim_set_hl(0, "MiniStatusLineModeReplace", {link = "StatusReplace"})
vim.api.nvim_set_hl(0, "MiniStatusLineModeInsert", {link = "StatusInsert"})
vim.api.nvim_set_hl(0, "MiniStatusLineModeVisual", {link = "StatusVisual"})
...
vim.api.nvim_set_hl(0, "MiniPickHeader", {link = "TelescopePromptNormal"})
vim.api.nvim_set_hl(0, "MiniPickMatchCurrent", {link = "TelescopeMatching"})
vim.api.nvim_set_hl(0, "MiniPickMatchMarked", {link = "TelescopeMatching"})
vim.api.nvim_set_hl(0, "MiniPickMatchRanges", {link = "TelescopeMatching"})
...
vim.api.nvim_set_hl(0, "MiniFilesBorder", {link = "TelescopeBorder"})
...
vim.api.nvim_set_hl(0, "MiniClueNextKey", {fg = oxocarbon.base08, bg = oxocarbon.blend, bold = true, italic = true})
vim.api.nvim_set_hl(0, "MiniClueDescGroup", {fg = oxocarbon.base15, bg = oxocarbon.blend, bold = true, italic = true})
...
vim.api.nvim_set_hl(0, "MiniDepsTitleError", {link = "Error"})
vim.api.nvim_set_hl(0, "MiniDepsTitleSame", {link = "MiniFilesTitle"})
...
vim.api.nvim_set_hl(0, "@number.quantity", {fg = oxocarbon.base11, bg = oxocarbon.none})
vim.api.nvim_set_hl(0, "@number.quantity.negative", {fg = oxocarbon.base10, bg = oxocarbon.none})
vim.api.nvim_set_hl(0, "LedgerComment", {link = "Comment"})
vim.api.nvim_set_hl(0, "LedgerTarget", {fg = oxocarbon.base09, bg = oxocarbon.none})
vim.api.nvim_set_hl(0, "LedgerCleared", {link = "Normal"})
vim.api.nvim_set_hl(0, "LedgerPending", {fg = oxocarbon.base09, bg = oxocarbon.none})
vim.api.nvim_set_hl(0, "LedgerPosting", {fg = oxocarbon.base14, bg = oxocarbon.none})
vim.api.nvim_set_hl(0, "LedgerInproperPerc", {fg = oxocarbon.base09, bg = oxocarbon.none})
vim.api.nvim_set_hl(0, "LedgerNumber", {link = "Constant"})
vim.api.nvim_set_hl(0, "LedgerNegativeNumber", {link = "ErrorMsg"})
vim.api.nvim_set_hl(0, "LedgerTransactionDate", {fg = oxocarbon.base12, bg = oxocarbon.none})
vim.api.nvim_set_hl(0, "LedgerTransactionExpression", {fg = oxocarbon.base13, bg = oxocarbon.none})
vim.api.nvim_set_hl(0, "@comment", {link = "Comment"})
vim.api.nvim_set_hl(0, "@date", {fg = oxocarbon.base08, bg = oxocarbon.none})
vim.api.nvim_set_hl(0, "@date.effective", {fg = oxocarbon.base13, bg = oxocarbon.none})
vim.api.nvim_set_hl(0, "@text.literal.commodity", {fg = oxocarbon.base13, bg = oxocarbon.none})
vim.api.nvim_set_hl(0, "@number", {fg = oxocarbon.base09, bg = oxocarbon.none})
vim.api.nvim_set_hl(0, "@number.date", {fg = oxocarbon.base14, bg = oxocarbon.none})
vim.api.nvim_set_hl(0, "@number.date.effective", {fg = oxocarbon.base13, bg = oxocarbon.none})
vim.api.nvim_set_hl(0, "@number.interval", {fg = oxocarbon.base09, bg = oxocarbon.none})
vim.api.nvim_set_hl(0, "@number.negative", {fg = oxocarbon.base10, bg = oxocarbon.none})
vim.api.nvim_set_hl(0, "@number.status", {fg = oxocarbon.base12, bg = oxocarbon.none})
vim.api.nvim_set_hl(0, "@number.quantity", {fg = oxocarbon.base09, bg = oxocarbon.none})
vim.api.nvim_set_hl(0, "@number.quantity.negative", {fg = oxocarbon.base10, bg = oxocarbon.none})
vim.api.nvim_set_hl(0, "TelescopePreviewLine", {fg = oxocarbon.none, bg = oxocarbon.base02})
vim.api.nvim_set_hl(0, "TelescopeSelectionCaret", {fg = oxocarbon.base10, bg = oxocarbon.none})
vim.api.nvim_set_hl(0, "@error", {fg = oxocarbon.base10, bg = oxocarbon.none})
