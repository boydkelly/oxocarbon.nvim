...
(custom-set-face! :FzfLuaBackdrop     [] {:fg oxocarbon.none :bg oxocarbon.blend})
...
; (custom-set-face! :FzfLuaBufFlagCur [] {:link "FzfLuaNormal"})
; (custom-set-face! :FzfLuaBufLineNr [] {:link "CursorLineNr"})
; (custom-set-face! :FzfLuaTabTitle [] {:fg oxocarbon.none :bg oxocarbon.blend})

; (custom-set-face! :FzfLuaCursor [] {:link "CursorLine"})
...
(custom-set-face! :FzfLuaFzfInfo [] {:link "FzfLuaNormal"})
; (custom-set-face! :FzfLuaFzfSeparator [] {:link "FzfLuaNormal"})
...
(custom-set-face! :FzfLuaCursor         [] {:link "FzfLuaNormal"})
(custom-set-face! :FzfLuaDirPart        [] {:link "FzfLuaNormal"})
(custom-set-face! :FzfLuaFilePart       [] {:link "FzfLuaNormal"})
(custom-set-face! :FzfLuaFzfCursorLine  [] {:link "FzfLuaNormal"})
(custom-set-face! :FzfLuaFzfPointer     [] {:link "FzfLuaNormal"})
(custom-set-face! :FzfLuaFzfMarker      [] {:link "FzfLuaNormal"})
(custom-set-face! :FzfLuaFzfSpinner      [] {:link "FzfLuaNormal"})
(custom-set-face! :FzfLuaFzfInfo        [] {:link "FzfLuaNormal"})
(custom-set-face! :FzfLuaFzfSeparator   [] {:link "FzfLuaNormal"})
...
(custom-set-face! :FzfLuaHeaderBind   [] {:link "FzfLuaNormal"})
(custom-set-face! :FzfLuaHeaderText   [] {:link "FzfLuaNormal"})
(custom-set-face! :FzfLuaPathColNr    [] {:link "FzfLuaNormal"})
(custom-set-face! :FzfLuaPathLineNr   [] {:link "FzfLuaNormal"})
(custom-set-face! :FzfLuaBufNr        [] {:link "FzfLuaNormal"})
(custom-set-face! :FzfLuaBufFlagCur   [] {:link "FzfLuaNormal"})
(custom-set-face! :FzfLuaBufFlagAlt   [] {:link "FzfLuaNormal"})
(custom-set-face! :FzfLuaTabTitle     [] {:link "FzfLuaNormal"})
(custom-set-face! :FzfLuaTabMarker    [] {:link "FzfLuaNormal"})
(custom-set-face! :FzfLuaLivePrompt   [] {:link "FzfLuaNormal"})
(custom-set-face! :FzfLuaLiveSym      [] {:link "FzfLuaNormal"})
